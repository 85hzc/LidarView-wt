#ifndef VTKWingtechPacketInterpreter_h
#define VTKWingtechPacketInterpreter_h
...
class VTK_EXPORT vtkWingtechPacketInterpreter : public vtkLidarPacketInterpreter
{
public:
  static vtkWingtechPacketInterpreter* New();
  vtkTypeMacro(vtkWingtechPacketInterpreter, vtkLidarPacketInterpreter)
...
protected:
  ...
  vtkWingtechPacketInterpreter();
  ~vtkWingtechPacketInterpreter();

private:
  vtkWingtechPacketInterpreter(const vtkWingtechPacketInterpreter&) = delete;
  void operator=(const vtkWingtechPacketInterpreter&) = delete;
...
struct WingtechSpecificFrameInformation : public SpecificFrameInformation
{
  ...
  void reset() override { *this = WingtechSpecificFrameInformation(); }
  std::unique_ptr<SpecificFrameInformation> clone() override { return std::make_unique<WingtechSpecificFrameInformation>(*this); }
};



#endif // VTKWingtechPacketInterpreter_h
